...
$InstDir/DownloadPrices.sh -b $BeginDate -e $EndDate >> $InstDir/log/$EndDate"_DownloadPrices" 2>&1
$InstDir/ConvertAll.sh -b $BeginDate -e $EndDate     >> $InstDir/log/$EndDate"_ConvertAll" 2>&1
